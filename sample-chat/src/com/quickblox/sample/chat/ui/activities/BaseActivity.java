...
public class BaseActivity extends Activity implements ApplicationSessionStateCallback {
    ...
    private static final String USER_LOGIN_KEY = "113124700727862199187_45309";
    private static final String USER_PASSWORD_KEY = "rgTwAfd5ihiQWzdeEQp7";
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if(needToRecreateSession){
            ...
            Log.d(JUAN, savedInstanceState.getString(USER_LOGIN_KEY));
